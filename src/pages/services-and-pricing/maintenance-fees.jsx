...
const MaintenanceFeesPage = () => {
  return (
    <Layout title='Platform Maintenance Fees' page='maintenance-fees'>
      <div style={{ height: 60 }} />
      <Padding>
        <h1>Platform Maintenance Fees</h1>
        <div style={{ height: 55 }} />
...
export default MaintenanceFeesPage
