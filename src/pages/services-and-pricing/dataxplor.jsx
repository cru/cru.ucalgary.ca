    ...
    <Layout title='DataXplor Released' page='dataxplor' group='services-and-pricing'>
      ...
      <Padding>
        ...
        <a
            ...
            >
              Get DataXplor today!
            </a> We offer affordable and flexible pricing plans to accommodate even the most limited research budgets. Bundle our tools to save even more.
        </p>
        <div>
        <h3>DataViz</h3>
        <p>
        ...
        <div>
          ...
          <p>Our flexible tool can be customized to track and present the data of greatest interest. Our experienced expert biostatistician is available for consultation to advise, analyze, and synthesize your data.</p>
        </div>
